...
const pinInputContainerRef =
    useTemplateRef(
        'pinInputContainerRef',
    );

const modalConfig =
    computed<TwoFactorConfigContent>(
        () => {
            if (
            ...
            >
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div
                            class="flex w-full items-center space-x-5"
                        >
                            <Button
                                class="w-full"
                                @click="
                        ...
                        >
                            ...
                            />
                            <span
                                class="bg-card relative px-2 py-1"
                            >
                                or,
                                enter
                                the code
