...
const isRecoveryCodesVisible =
    ref<boolean>(false);
const recoveryCodeSectionRef =
    useTemplateRef(
        'recoveryCodeSectionRef',
    );
...
<template>
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                Recovery codes let you
                regain access if you
        ...
        <CardContent>
            ...
            >
                ...
                >
                    ...
                    <p
                        class="text-muted-foreground text-xs select-none"
                    >
                        Each recovery
                        code can be used
                        once to access
