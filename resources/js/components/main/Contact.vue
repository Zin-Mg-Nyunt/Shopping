...
<template>
    ...
    >
        ...
        >
            ...
            <div>
                <h2
                    class="mb-6 text-2xl font-bold sm:text-3xl"
                >
                    Get in Touch
                </h2>
                <div class="space-y-4">
                ...
                <div class="mt-8">
                    ...
                    >
                        <a
                            href="#"
                            class="bg-primary/10 hover:bg-primary hover:text-primary-foreground flex h-10 w-10 items-center justify-center rounded-lg transition-colors"
                            aria-label="Facebook"
                        >
                            <svg
                                class="h-5 w-5"
